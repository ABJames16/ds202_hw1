...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: My name is **Adam Banwell**. My major is *Software Engineering* and my professional interests include many topics from my current internship such as programming with gps, satellite, and agriculture algorithms for improving farm soil.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: A data scientist job will be related to data science using mathematics and computer technology to display data analysis. A data scientist takes business applications and performs analysis through dashboarding and visualizations. This can best be used in a cloud based environment with large quantities of ingested data.
            <https://www.sas.com/en_us/insights/analytics/what-is-a-data-scientist.html>
            ![image](https://miro.medium.com/max/1040/1*T5GfsoZ-IWK3rcVkZ7R2bw.png)
...
6. To check that your R and Rstudio installation is correct, find the version of R by entering `version` into the R console. Include this command into a R code trunk in your solution `Rmd` file to have it automatically printed in the knitted html file. 
    ...
    Answer: version.string R version 4.1.1 (2021-08-10)
